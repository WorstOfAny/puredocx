...
module PureDocx
  module XmlGenerators
    class Text < Base
      ...
      attr_reader :bold_enable, :italic_enable, :align, :size, :underline, :list_property, :left_indent, :first_line_indent, :color
      ...
      def initialize(content, rels_constructor, arguments = {})
        ...
        @left_indent      = arguments[:left_indent] || 0
        @first_line_indent = arguments[:first_line_indent] || 0
